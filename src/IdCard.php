...
class IdCard
{
    ...
    /** @var array|int[] 加权因子 */
    protected array $salt = [7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2];
    /** @var array|int[] 校验码 */
    protected array $checksum = [1, 0, 'X', 9, 8, 7, 6, 5, 4, 3, 2];
     ...
     */
    public function verification($idCard):array
    {
